...
{
    [UsedImplicitly]
    public class Repository : ClassStructureBase
    {
        private const string StructureName = "Domain/Repository";
        ...
        protected override LayerType LayerType { get; } = LayerType.Repository;
        ...
        public override void Generate(bool overwrite)
        {
            ...
            parameter.UsingList.Add("CAFU.Core.Domain.Repository");
