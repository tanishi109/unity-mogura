...
{
    [UsedImplicitly]
    public class Model : ClassStructureBase
    {
        private const string StructureName = "Domain/Model";
        ...
        protected override LayerType LayerType { get; } = LayerType.Model;
        ...
        public override void Generate(bool overwrite)
        {
            ...
            parameter.UsingList.Add("CAFU.Core.Domain.Model");
